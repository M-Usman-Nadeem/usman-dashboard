...
export default () => {
  let arr = [
    {
      employees:[{name:"Justin Lipshutz",pic:img2},{name:"Marcus Culhane",pic:img3},{name:"Leo Stanton",pic:img4}],
  ...
  return (
      <>
        <section className="  border-opacity-100 p-[15px] sm:p-[27px] w-full md:w-[90%] xl:w-[73%]   border-[1.81193px]">
          <div className="flex justify-between  w-full pb-[24px]   ">
            <p className=" whitespace-nowrap sm:text-[20px] font-bold ">Employee Status</p>
          ...
          <div className="    overflow-x-auto ">
            <ul className=" flex   ">
              ...
              <li  className="text-[#949494] text-[14.5px] border-b-[1.81193px] pb-[14px] whitespace-nowrap">Employee Name</li>
              <ul className="pt-[18px] mr-[72px]">

            {arr[0].employees.map(item=>{
              return    <li className="flex items-center   sm:gap-3 font-bold   ">
    ...
    {item.name}
              ...
              <ul className=" self-start  ">
                <li className="text-[#949494] text-[14.5px] pb-[14px] border-b-[1.81193px] pl-[70px] w-full   ">Department</li>
              <ul className="font-bold flex flex-col gap-[36px] ml-[72px] pt-[36px] ">
                ...
                <li  className="text-[#949494] text-[14.5px] pb-[14px] border-b-[1.81193px] pl-[70px] w-full ">Age</li>
...
{arr[0].ages.map(item=>{
  return     <li className="text-left w-[66px]">{item}</li>            })}
                ...
                <li  className="text-[#949494] text-[14.5px] pb-[14px] border-b-[1.81193px] pl-[62px] w-full ">Disipline</li>
          ...
          <ul className="self-start flex flex-col ">
              <li  className="text-[#949494] text-[14.5px] pb-[14px]  border-b-[1.81193px] pl-[68px] w-full ">Status</li>
